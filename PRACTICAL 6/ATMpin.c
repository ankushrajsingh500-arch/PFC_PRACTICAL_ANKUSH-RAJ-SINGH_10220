...
// output PS C:\Users\anime\OneDrive\Desktop\PFC PRACTICAL> cd "c:\Users\anime\OneDrive\Desktop\PFC PRACTICAL\practical 6\" ; if ($?) { gcc ATMpin.c -o ATMpin } ; if ($?) { .\ATMpin }
